...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    description: "Visit us in store for pricing!",
    items: [
      { name: "Aguas Frescas", description: "Refreshing fruit-flavored water drinks", prices: [] },
      { name: "Churros Preparados", description: "Crispy churros with your choice of toppings", prices: [] },
      { name: "Fresas Dubai", description: "Strawberries topped with chocolate and pistachios", prices: [] },
      { name: "Raspados", description: "Shaved ice with fruit and flavored syrups", prices: [] },
      { name: "Chocobananas", description: "Frozen chocolate-covered bananas", prices: [] },
      { name: "Cazuelitas", description: "Mini fruit bowls with cream and toppings", prices: [] },
      { name: "Fresas Con Crema", description: "Fresh strawberries with sweet cream", prices: [] },
      { name: "Banana Split", description: "Classic banana split with ice cream and toppings", prices: [] },
      { name: "Hot Dogs", description: "Hot-dog style snack with toppings", prices: [] },
      { name: "Chamango", description: "Mango with chamoy and chili", prices: [] },
      { name: "Maruchan Loca", description: "Ramen noodles with chamoy and toppings", prices: [] },
      { name: "Chilindrinas", description: "Crispy chips with chamoy and toppings", prices: [] },
      { name: "Torta Del Chavo", description: "Classic Mexican treat", prices: [] },
      { name: "Bionico", description: "Fresh fruit bowl with cream and granola", prices: [] },
      { name: "Elote En Vaso", description: "Corn in a cup with mayo, cheese, and chili", prices: [] },
      { name: "Malteadas Chicas", description: "Small milkshakes in various flavors", prices: [] },
      { name: "Mango En Vaso", description: "Fresh mango in a cup with chili and lime", prices: [] },
      { name: "Monster Preparado", description: "Monster energy drink with chamoy and candy", prices: [] },
      { name: "Tostitos Preparados", description: "Tostitos chips with toppings", prices: [] },
      { name: "Elotes Chorreados", description: "Mexican street corn with drizzled toppings", prices: [] },
      { name: "Dorilocos", description: "Doritos loaded with various toppings", prices: [] },
    ],
  },
];
