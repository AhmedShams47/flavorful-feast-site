    ...
    <section id="contact" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-card border border-border/50 card-hover">
            ...
            <a
              ...
              className="text-primary hover:text-primary/80 transition-colors text-xl font-bold flex items-center gap-2 mb-2"
            >
        ...
        <div className="text-center mt-12">
          <a
            href="tel:+14052851616"
            className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-10 py-4 rounded-full font-bold text-xl hover:scale-105 transition-all glow-primary"
          >
            <Phone className="w-5 h-5" />
            Call to Order Now
          </a>
